...
function buildSummarySlide() {
  ...
  <div class="slide" id="slide-summary">
    <div class="title-slide">
      ...
      <p style="margin-top:3rem;color:#9ca3af;font-size:0.9rem;">お問い合わせ: s.nita@vicent.co.jp</p>
    </div>
  </div>`
}
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .flow-sub { font-size: 0.72rem; color: #9ca3af; max-width: 100px; line-height: 1.3; }
    .flow-arrow {
      font-size: 1.5rem; color: #22d3ee; margin: 0 0.5rem;
      align-self: center; padding-bottom: 1.5rem;
    }
    .flow-caption {
      text-align: center; color: #9ca3af; font-size: 0.85rem; margin-top: 2rem;
    }
